...
@Component({
  ...
  template: `
	<a [routerLink]="['']" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" class="button">
	...
	<a [routerLink]="['/SearchComponent']" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" class="button">
	...
	<a [routerLink]="['/ProfileComponent']" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" class="button">
